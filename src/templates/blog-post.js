    ...
    <ThemeProvider>
      <div className="container flex flex-col mx-auto">
        ...
        <div className="pt-20 px-5 py-10 mx-auto w-full sm:w-5/6 md:w-4/6 container flex flex-col items-center markdown">
          ...
          <p className="text-md font-semibold text-gray-700 dark:text-gray-200 mb-16">{post.frontmatter.date} • {post.frontmatter.category} • {post.fields.readingTime.text}</p>
